...
<div class="header">
    <div class="header__left">
        <span>Job Indicator List</span>
    </div>

    <div class="header__right">
        <a href="/joblist/new" class="btn btn-primary">
            New job
        </a>
    </div>
</div>
...
<div class="jobs">
    @foreach($jobs as $job)
        <div class="job__item joblist" data-job-id="{{ $job['id'] }}">
                ...
                @foreach($job['applications'] as $application)
                    <div class="job__item__slide--application">
                        <div class="job__item__slide--application--header">
                            ...
                            <div class="job__item__slide--application--header__right">
                                <button type="button" class="btn btn-primary application-toggler">
                                    +
                                </button>
                            </div>
                        </div>

                        <div class="job__item__slide--application--slide">
                            ...
                            <div class="job__item__slide--application--skills">
                                <h3>Competence Levels</h3>

                                <div class="job__item__slide--application--skills__list">
                                    <ul>
                                        @foreach($application['skills'] as $skill)
                                            <li>
                                                <b>{{ $skill['competence']['competence'] }}</b>
